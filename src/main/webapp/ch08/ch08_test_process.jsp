					...
					<div class="col-md-12">
						...
						<form action="ch08_test_process.jsp" method="post" id="frm">
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="quest1" name="quest1" value="${param.quest1 }"/>
									<p class="ddit_text" id="err_quest1" style="color: green;">정상</p>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="quest2" name="quest2" value="${param.quest2 }"/>
									<p class="ddit_text" id="err_quest2" style="color: green;">정상</p>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="mem_id" name="mem_id" value="${param.mem_id }"/>
									<p class="ddit_text" id="err_id" style="color: green;">정상</p>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="mem_pw" name="mem_pw" value="${param.mem_pw }"/>
									<p class="ddit_text" id="err_pw" style="color: green;">정상</p>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="mem_name" name="mem_name" value="${param.mem_name }"/>
									<p class="ddit_text" id="err_name" style="color: green;">정상</p>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" id="mem_phone" name="mem_phone" value="${param.mem_phone }"/>
									<p class="ddit_text" id="err_phone" style="color: green;">정상</p>
								</div>
							</div>
